...
//   myHistos->book("lateral_profile",100,-10,10,100,-10,10);
//   myHistos->book("r_vs_depth",100,0,10,100,-10,10);

   myHistos->book("Energy_vs_Depth_ECAL",100,0,10,140,0,0.6);
   myHistos->book("lateral_profile_ECAL",100,-10,10,100,-10,10);
   myHistos->book("r_vs_depth_ECAL",100,0,10,100,-10,10);
...
ETOT=ETOT+spotIter->getEnergy()/CLHEP::GeV;

 
//std::cout<<"currentDepth     "<<currentDepth<<std::endl;
//std::cout<<"currentTime     "<<spotIter->getTime()<<std::endl;

//std::cout<<"currentDepth     "<<currentDepth<<"    getPathLengthOnEcal    "<<theProfile->getGflashShowino()->getPathLengthOnEcal()<<"    egen      "<<eGen<<std::endl;
...
if (currentDepth/Gflash::intLength[Gflash::kHB]>3 && currentDepth/Gflash::intLength[Gflash::kHB]<3.2){
